...
export * from "./patch";
export declare function generateRandomSheetName(file: Sheet[], isPivotTable: boolean, ctx: Context): any;
...
export declare function getSheetByIndex(ctx: Context, id: string): any;
...
export declare function isAllowEdit(ctx: Context, range?: Sheet["luckysheet_select_save"]): any;
