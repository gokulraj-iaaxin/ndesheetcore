...
export declare function toolbarItemClickHandler(name: string): ToolbarItemClickHandler | undefined;
export declare function toolbarItemSelectedFunc(name: string): ToolbarItemSelectedFunc | undefined;
export {};
