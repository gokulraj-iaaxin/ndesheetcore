...
export declare function getOrigincell(ctx: Context, r: number, c: number, i: string): any;
...
export declare function isAllSelectedCellsInStatus(ctx: Context, attr: keyof Cell, status: any): any;
 ...
 * @returns 计算后的配置
 */
export declare function getdatabyselection(ctx: Context, range: Selection | undefined, sheetId: string): any[][];
export declare function luckysheetUpdateCell(ctx: Context, row_index: number, col_index: number): void;
export declare function getDataBySelectionNoCopy(ctx: Context, range: Selection): any[][];
